...
const routes = [
  ...
  { path: '/course/homeworklist/:id', name: 'HomeWorkList', component: HomeWorkList },
  { path: '/course/homeworkstudentlist/:id', name: 'HomeWorkStudentList', component: HomeWorkStudentList },
